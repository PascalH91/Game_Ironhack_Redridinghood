...
class FenceDoor {
  setup() {
    fenceDoorClosedSpritesheet = loadSpriteSheet(
      "Assets/Spritesheets/PFOR_500_1000_CLOSED.png",
      500,
      1000,
      50
    );
    fenceDoorClosedAnimation = loadAnimation(fenceDoorClosedSpritesheet);
    fenceDoorOpeningSpritesheet = loadSpriteSheet(
      "Assets/Spritesheets/PFOR_500_1000_OPENING.png",
      500,
      1000,
      50
    );
    fenceDoorOpeningAnimation = loadAnimation(fenceDoorOpeningSpritesheet);
    fenceDoorOpenSpritesheet = loadSpriteSheet(
      "Assets/Spritesheets/PFOR_500_1000_OPENALWAYS.png",
      500,
      1000,
      50
    );
...
class House {
  setup() {
    houseSpritesheet = loadSpriteSheet(
      "Assets/Spritesheets/Haus__1500_1000_noDoor.png",
      1500,
      1000,
      75
    );
...
class HouseDoor {
  setup() {
    houseDoorClosedSpritesheet = loadSpriteSheet(
      "Assets/Spritesheets/Haus__1500_1000_closedDoor.png",
      1500,
      1000,
      50
    );
    houseDoorAnimationclosed = loadAnimation(houseDoorClosedSpritesheet);
    houseDoorOpeningSpritesheet = loadSpriteSheet(
      "Assets/Spritesheets/Haus__1500_1000_openingDoor.png",
      1500,
      1000,
      25
    );
...
class Target {
  setup() {
    targetSpritesheet = loadSpriteSheet(
      "Assets/Spritesheets/target_Sprite_200_1000.png",
      200,
      1000,
      25
    );
